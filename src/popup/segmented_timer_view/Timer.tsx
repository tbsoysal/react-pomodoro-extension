  ...
  return (
    <div className="relative h-[164px] flex justify-center items-center my-5">
      <div className={`absolute flex gap-3 top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] text-2xl text-black`}>
        <div className='w-[130px] h-[88px] relative'>
          <img className='w-full h-full' src={digitalNumbersBg} />
          <p className='absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] !font-["Digital_Numbers_Regular"] text-5xl'>
